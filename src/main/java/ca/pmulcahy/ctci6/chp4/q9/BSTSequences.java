...
public class BSTSequences {
	 ...
	 */
	public static <T extends Comparable<T>> void weave(final LinkedList<T> prefix, 
													   final LinkedList<T> leftSequence, 
													   final LinkedList<T> rightSequence, 
													   final Set<LinkedList<T>> results) {
		if(leftSequence.isEmpty() || rightSequence.isEmpty()) { // Recursion Base Case
