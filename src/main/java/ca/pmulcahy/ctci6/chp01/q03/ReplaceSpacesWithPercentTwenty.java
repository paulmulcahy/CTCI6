 ...
 * operation in place.)
 */
public class ReplaceSpacesWithPercentTwenty {
  public static final Character EMPTY_CHAR = ' ';

  public static String replaceSpacesWithPercentTwenty(String str) {
    final Character[] characterArrayWithSpaceAllocatedForAdditionalCharacters =
        toCharacterArrayWithSpaceAllocatedForAdditionalCharacters(str);
    final Character[] characterArrayWithSpacesReplacedByPercentTwenty =
        replaceSpacesWithPercentTwentyInPlace(
            characterArrayWithSpaceAllocatedForAdditionalCharacters);
    final char[] charArrayWithSpacesReplacedByPercentTwenty =
        characterArrayToCharArray(characterArrayWithSpacesReplacedByPercentTwenty);
