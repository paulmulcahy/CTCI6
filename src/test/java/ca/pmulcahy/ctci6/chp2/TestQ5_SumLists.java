...
public class TestQ5_SumLists {
	
	@Test
	public void emptyReverse() {
		final SinglyLinkedList<Integer> sList = new SinglyLinkedList<>();			
		
		final SinglyLinkedList<Integer> actual = Q5_SumLists.sumReverse(sList, sList);
		assertEquals(sList, actual,  "The summed lists: " + sList + " and " + sList + " are empty and so the empty list should be returned.");
	}
	...
	public void emptyForward() {
		...
		final SinglyLinkedList<Integer> actual = Q5_SumLists.sumForward(sList, sList);
		assertEquals(sList, actual,  "The summed lists: " + sList + " and " + sList + " are empty and so the empty list should be returned.");
	}
	...
	public void lengthOneReverse() {
		...
		final SinglyLinkedList<Integer> actual = Q5_SumLists.sumReverse(sList, sList);
		assertEquals(expected, actual,  "The lists: " + sList + " and " + sList + " have only 1 element each so the result should be " + expected);
	}
	...
	public void bookReverse() {
		...
		final SinglyLinkedList<Integer> actual = Q5_SumLists.sumReverse(sList1, sList2);
		assertEquals(expectedLinkedList, actual,  "The lists: " + sList1 + " and " + sList2 + " are detailed in the book and the result should be " + expectedLinkedList);
	}
	...
	public void bookForward() {
		...
		final SinglyLinkedList<Integer> actual = Q5_SumLists.sumForward(sList1, sList2);
		assertEquals(expectedLinkedList, actual,  "The lists: " + sList1 + " and " + sList2 + " are detailed in the book and the result should be " + expectedLinkedList);
	}
