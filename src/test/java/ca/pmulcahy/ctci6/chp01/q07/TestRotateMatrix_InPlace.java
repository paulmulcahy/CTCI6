...
class TestRotateMatrix_InPlace {
  ...
  void nDifferentSizes() {
    ...
    final long[][] actual = RotateMatrix_InPlace.rotate(matrix);
  ...
  void nSizeTwo() {
    ...
    final long[][] actual = RotateMatrix_InPlace.rotate(toRotate);
