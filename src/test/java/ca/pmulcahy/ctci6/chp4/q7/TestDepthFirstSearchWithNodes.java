...
public class TestDepthFirstSearchWithNodes {
	...
	public void bookExample() {
		final List<Character> expected = new ArrayList<Character>(List.of('f', 'e', 'b', 'a', 'd', 'c'));
	...
	public void incompleteProjectList() {
		...
		assertThrows(DepthFirstSearch.IncompleteProjectListException.class, () -> DepthFirstSearch.getBuildOrder(projects, dependencies));		
	}
	...
	public void impossible() {		
		...
		assertThrows(DepthFirstSearch.CyclicalDependencyException.class, () -> DepthFirstSearch.getBuildOrder(projects, dependencies));
	}
}
